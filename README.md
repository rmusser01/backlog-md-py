...
Browser editor/settings gaps, remaining board interactivity, and remaining git automation are
...
- `docs/interactive-deferrals.md` records the implemented task detail/editor
  and search filter flows, remaining CLI/TUI deferrals, hook bypass, and
