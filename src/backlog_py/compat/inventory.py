...
def load_builtin_inventory() -> CompatibilityInventory:
    items = (
        ...
        _golden(
            "cli:task-create",
            "CLI-INSTRUCTIONS.md",
            "backlog task create <title> --id <id> --draft -d <text> --desc <text> -s <status> --plan <text> --notes <text> --final-summary <text> -p <taskId> --parent <taskId> -m <milestone> --milestone <milestone> --ordinal <number> --ref <item> --doc <item> --modified-file <path> -a <assignee> -l <label> --priority <priority> --ac <item> --definition-of-done <item> --dod <item> --definition-of-done-add <item> --disable-definition-of-done-defaults --no-dod-defaults --dep <id> --dependency <id> --plain",
        ),
        _golden(
            "cli:draft-create",
            "CLI-INSTRUCTIONS.md",
        ...
        _golden(
            "cli:task-edit",
            "CLI-INSTRUCTIONS.md",
            "backlog task edit <id> --title <title> -s <status> -d <text> --desc <text> --plan <text> --append-plan <text> --clear-plan -m <milestone> --milestone <milestone> --ordinal <number> --clear-milestone --ref <item> --doc <item> --modified-file <path> -a <assignee> -l <label> --priority <priority> --ac <item> --dod <item> --remove-ac <index> --dep <id> --dependency <id> --plain",
        ),
        _golden(
