...
def load_builtin_inventory() -> CompatibilityInventory:
    items = (
        ...
        _golden(
            "cli:init",
            "CLI-INSTRUCTIONS.md",
            "backlog init [project-name] --defaults [--no-git] --backlog-dir <path> --task-prefix <prefix> --config-location <location> --agent-instructions",
        ),
        _golden(
            "cli:task-list-plain",
            "CLI-INSTRUCTIONS.md",
            "backlog task list --status <status> --priority <priority> -a <assignee> -l <label> --milestone <milestone> -p <taskId> --parent <taskId> --plain",
        ),
        ...
        _golden(
            "cli:task-create",
            "CLI-INSTRUCTIONS.md",
            "backlog task create <title> --id <id> --draft -d <text> --desc <text> -s <status> --plan <text> --notes <text> --final-summary <text> -p <taskId> --parent <taskId> --milestone <milestone> --ordinal <number> --ref <item> --doc <item> --modified-file <path> -a <assignee> -l <label> --priority <priority> --ac <item> --dod <item> --no-dod-defaults --dep <id> --dependency <id> --plain",
        ),
        _golden(
            "cli:draft-create",
            "CLI-INSTRUCTIONS.md",
        ...
        _golden(
            "cli:task-edit",
            "CLI-INSTRUCTIONS.md",
            "backlog task edit <id> --title <title> -s <status> -d <text> --desc <text> --plan <text> --append-plan <text> --clear-plan --milestone <milestone> --ordinal <number> --clear-milestone --ref <item> --doc <item> --modified-file <path> -a <assignee> -l <label> --priority <priority> --ac <item> --dod <item> --remove-ac <index> --dep <id> --dependency <id> --plain",
        ),
        _golden(
        ...
        _golden("cli:doc-list", "CLI-INSTRUCTIONS.md", "backlog doc list [query]"),
        _golden("cli:doc-view", "CLI-INSTRUCTIONS.md", "backlog doc view <path-or-id>"),
        _golden(
            "cli:doc-create",
            "CLI-INSTRUCTIONS.md",
            "backlog doc create <path-or-title> --title <title> -p <path> --path <path> -t <type> --type <type> --tags <tags> --content <body>",
        ),
        _golden(
            "cli:doc-update",
            "CLI-INSTRUCTIONS.md",
            "backlog doc update <path-or-id> --title <title> -p <path> --path <path> -t <type> --type <type> --tags <tags> --content <body>",
        ),
        _golden(
            "cli:decision-create",
            "CLI-INSTRUCTIONS.md",
        ...
        _golden(
            ...
            "CLI-INSTRUCTIONS.md",
            "backlog milestone rename <old> <new> --update-tasks",
        ),
        _golden("cli:milestone-remove", "CLI-INSTRUCTIONS.md", "backlog milestone remove <name> --clear-tasks"),
