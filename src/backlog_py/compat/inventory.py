...
def load_builtin_inventory() -> CompatibilityInventory:
    items = (
        ...
        _golden(
            "cli:task-list-plain",
            "CLI-INSTRUCTIONS.md",
            "backlog task list -s <status> --status <status> --priority <priority> -a <assignee> --assignee <assignee> -l <label> --label <label> -m <milestone> --milestone <milestone> -p <taskId> --parent <taskId> --plain",
        ),
        ...
        _golden(
            "cli:task-create",
            "CLI-INSTRUCTIONS.md",
            "backlog task create <title> --id <id> --draft -d <text> --desc <text> --description <text> -s <status> --status <status> --plan <text> --notes <text> --final-summary <text> -p <taskId> --parent <taskId> -m <milestone> --milestone <milestone> --ordinal <number> --ref <item> --doc <item> --modified-file <path> -a <assignee> --assignee <assignee> -l <label> --label <label> --priority <priority> --ac <item> --acceptance-criteria <item> --definition-of-done <item> --dod <item> --definition-of-done-add <item> --disable-definition-of-done-defaults --no-dod-defaults --dep <id> --dependency <id> --plain",
        ),
        _golden(
            "cli:draft-create",
            "CLI-INSTRUCTIONS.md",
        ...
        _golden("mcp:init-required", "agent-nudge.md", "backlog://init-required"),
        _golden("mcp:project-status", "MCP tools", "project_status(project, recentLimit=5)"),
