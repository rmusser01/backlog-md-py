...
| mcp:task-create | implemented | task_create(project, id=None, status=None, ordinal=None, milestone=None, parentTaskId=None, references=None, documentation=None, modifiedFiles=None, implementationPlan=None, finalSummary=None, **kwargs) | mcp:task-create |
