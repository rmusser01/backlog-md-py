...
| cli:task-edit | implemented | backlog task edit <id> --title <title> -s <status> -d <text> --desc <text> --plan <text> --append-plan <text> --clear-plan --milestone <milestone> --ordinal <number> --clear-milestone --ref <item> --doc <item> --modified-file <path> -a <assignee> -l <label> --priority <priority> --ac <item> --dod <item> --remove-ac <index> --dep <id> --dependency <id> --plain | cli:task-edit |
