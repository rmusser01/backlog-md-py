...
| cli:task-create | implemented | backlog task create <title> -a <assignee> -l <label> --priority <priority> --ac <item> --dod <item> --dep <id> --plain | cli:task-create |
| cli:task-edit | implemented | backlog task edit <id> -a <assignee> -l <label> --priority <priority> --ac <item> --remove-ac <index> --plain | cli:task-edit |
...
| mcp:task-create | implemented | task_create(project, assignee=None, labels=None, priority=None, **kwargs) | mcp:task-create |
| mcp:task-edit | implemented | task_edit(project, task_id, assignee=None, labels=None, priority=None, **kwargs) | mcp:task-edit |
